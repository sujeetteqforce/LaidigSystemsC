...
namespace LaidigSystemsC.Models
{
    public class DelayedJob : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            //string UserName = HttpContext.Current.Session["YourSession"].ToString();
            List<FileDetail> fileDetails = new List<FileDetail>();
            List<CsvFile> listcsvfiles = new List<CsvFile>();

            List<CsvFile> Csvfiles = new List<CsvFile>();
            DirectoryInfo d = new DirectoryInfo("E:/LaidigSystemsC_Project/LaidigSystemsC/LaidigSystemsC/App_Data/Delayed/CsvFile/UserName-sujeet/Date-14-11-2016");//Assuming Test is your Folder
            FileInfo[] Files = d.GetFiles("*.csv"); //Getting Text files

            //string[] filePaths = Directory.GetFiles("~/App_Data/Delayed/CsvFile/UserName-sujeet/Date-" + string.Format("{0:dd-MM-yyyy}", DateTime.Now, "*.bmp");
            var path = "";
